...
typedef char TSecurityFtdcAdjustStatusType;
...
typedef char TSecurityFtdcTermTradeTargetType;
...
typedef char TSecurityFtdcPlatformIDType;
...
typedef char TSecurityFtdcPlatformStateType;
